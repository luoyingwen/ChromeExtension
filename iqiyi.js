...
(function () {
    ...
    console.log("xmlhttprequest installed");
	...
	cXMLHttpRequest.prototype.open  = function(sMethod, sUrl, bAsync, sUser, sPassword) {
        ...
        console.log("luoyw url=" + sUrl);
        var videourls = document.getElementsByTagName("videourl");
        if (videourls.length > 0) {
            videourls[0].setAttribute("url", sUrl);
            console.log("luoyw, set attribute");
        }
